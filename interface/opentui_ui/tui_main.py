"""OpenTUI entry point for JARVIS."""
...
from interface.opentui_ui.app import run_opentui_ui
...
def main(model: str = "gpt-4o", base_url: str | None = None, apikey: str | None = None, sdk: str = "openai", bypass: bool = False, resume_session: str | None = None) -> None:
    """Main TUI entry point with enhanced JARVIS core integration using OpenTUI."""
    ...
    run_opentui_ui(
        ...
        async_agent_manager=async_agent_manager,
