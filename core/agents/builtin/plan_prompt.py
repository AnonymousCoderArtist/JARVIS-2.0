...
def GetPlanSystemPrompt() -> str:
    ...
    Returns:
        System prompt for the plan agent specialized in task decomposition.
    """
    date = datetime.now().strftime("%Y-%m-%d")
    cwd = os.getcwd()

    return f"""You are a software architect and planning specialist for JARVIS. Your role is to explore the codebase and design implementation plans.
