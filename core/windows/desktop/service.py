from core.windows.desktop.utils import (
    ps_quote,
    ps_quote_for_xml,
    resolve_known_folder_guid_path,
)
from core.windows.desktop.powershell import PowerShellExecutor
from core.windows.vdm.core import (
    get_all_desktops,
    get_current_desktop,
    is_window_on_current_desktop,
)
from core.windows.desktop.views import DesktopState, Window, Browser, Status, Size
from core.windows.tree.views import BoundingBox, TreeElementNode, TreeState
from concurrent.futures import ThreadPoolExecutor
from PIL import ImageFont, ImageDraw, Image
from core.windows.tree.service import Tree
from core.windows.desktop import screenshot as screenshot_capture
...
import core.windows.uia as uia  # noqa: E402
...
class Desktop:
    ...
    def bring_window_to_top(self, target_handle: int):
        ...
        try:
            ...
            # SetForegroundWindow is called from our JARVIS thread, and Windows requires
    ...
    def send_notification(self, title: str, message: str, app_id: str) -> str:
        ...
        Notes:
            The JARVIS client MUST provide an App ID because Windows uses it as the
