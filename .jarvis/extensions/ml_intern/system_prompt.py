"""ML Intern system prompt — adapted from huggingface/ml-intern agent/prompts/system_prompt_v3.yaml."""

_NUM_TOOLS = 18  # resolved at runtime in get_system_prompt()


def get_system_prompt(num_tools: int | None = None) -> str:
    n = num_tools or _NUM_TOOLS
    return _PROMPT.replace("{{ num_tools }}", str(n))
