...
Usage:
    from jarvis.core.agents.prompts import get_agent_prompt, get_jarvis_v2_prompt
...
def _load_builtin_prompts() -> None:
    ...
    if not _BUILTIN_PROMPTS_LOADED:
        try:
            from jarvis.core.agents.builtin.jarvis_help_agent import GetJarvisHelpPrompt
            from jarvis.core.agents.builtin.statusline_setup_agent import GetStatuslineSetupPrompt
...
def _init_prompts() -> None:
    ...
    if _RUNTIME_RUBBER_DUCK_PROMPT is None:
        from jarvis.core.agents.builtin.rubber_duck_agent import GetRubberDuckPrompt
