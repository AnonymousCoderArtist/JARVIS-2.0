...
from jarvis.core.tools.base import BaseTool, ToolInput, ToolOutput, resolve_tool_ref
...
class AgentTool(BaseTool):
    ...
    async def _handle_list_agents(self) -> ToolOutput:
        ...
        from jarvis.core.agents.custom_loader import discover_custom_agents
    ...
    async def _handle_launch(self, agent_name: str, prompt: str, runInBackground: bool, tool_use_id: str = "") -> ToolOutput:
        ...
        if runInBackground:
            ...
            if event_queue:
                from jarvis.interface.textual_ui.types import AgentToolCallEvent
