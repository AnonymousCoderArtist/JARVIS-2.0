...
def _get_agent():
    ...
    from jarvis.core.agents.system_prompts import get_system_context
    ...
    from jarvis.core.tools.web_tools import WebFetchTool
...
async def api_list_providers():
    ...
    try:
        from jarvis.core.provider.manager import ProviderManager
        pm = ProviderManager()
        providers = []
...
async def api_mcp_list_servers():
    """List MCP servers."""
    try:
        from jarvis.core.tools.mcp_adapter import MCPRegistry, load_mcp_config_from_file
...
async def api_list_connectors():
    ...
    try:
        from jarvis.core.connectors.registry import ConnectorRegistry, load_connectors
        load_connectors()
