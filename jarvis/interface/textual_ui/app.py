...
from jarvis.core.agents.base import ApprovalResponse
from jarvis.core.llm_sdk.context_length_manager import context_length_manager
...
from jarvis.interface.textual_ui.constants import CORE_VERSION
from jarvis.interface.textual_ui.handlers.event_handler import EventHandler
from jarvis.interface.textual_ui.notifications import (
    NotificationContext,
    NotificationPort,
    TextualNotificationAdapter,
)
from jarvis.interface.textual_ui.quit_manager import QuitManager
from jarvis.interface.textual_ui.remote import RemoteSessionManager, is_progress_event
...
from jarvis.interface.textual_ui.utils import (
    CancellationReason,
    get_user_cancellation_message,
    is_dangerous_directory,
)
from jarvis.interface.textual_ui.widgets.approval_app import ApprovalApp
from jarvis.interface.textual_ui.widgets.banner.banner import Banner
from jarvis.interface.textual_ui.widgets.chat_input import ChatInputContainer
from jarvis.interface.textual_ui.widgets.chat_input.text_area import ChatTextArea
from jarvis.interface.textual_ui.widgets.compact import CompactMessage
from jarvis.interface.textual_ui.widgets.config_app import ConfigApp
from jarvis.interface.textual_ui.widgets.connector_auth_app import ConnectorAuthApp
from jarvis.interface.textual_ui.widgets.context_progress import ContextProgress, TokenState
from jarvis.interface.textual_ui.widgets.debug_console import DebugConsole
from jarvis.interface.textual_ui.widgets.feedback_bar import FeedbackBar
from jarvis.interface.textual_ui.widgets.feedback_bar_manager import FeedbackBarManager
from jarvis.interface.textual_ui.widgets.load_more import HistoryLoadMoreRequested
from jarvis.interface.textual_ui.widgets.loading import (
    DEFAULT_LOADING_STATUS,
    LoadingWidget,
    paused_timer,
)
from jarvis.interface.textual_ui.widgets.mcp_app import MCPApp, MCPSourceKind
from jarvis.interface.textual_ui.widgets.messages import (
    AssistantMessage,
    BashOutputMessage,
    ErrorMessage,
    InterruptMessage,
...
from jarvis.interface.textual_ui.widgets.model_picker import ModelPickerApp
from jarvis.interface.textual_ui.widgets.narrator_status import NarratorStatus
from jarvis.interface.textual_ui.widgets.no_markup_static import NoMarkupStatic
from jarvis.interface.textual_ui.widgets.path_display import PathDisplay
from jarvis.interface.textual_ui.widgets.proxy_setup_app import ProxySetupApp
from jarvis.interface.textual_ui.widgets.question_app import QuestionApp
from jarvis.interface.textual_ui.widgets.rewind_app import RewindApp
from jarvis.interface.textual_ui.widgets.session_picker import SessionPickerApp
from jarvis.interface.textual_ui.widgets.teleport_message import TeleportMessage
from jarvis.interface.textual_ui.widgets.thinking_picker import ThinkingPickerApp
from jarvis.interface.textual_ui.widgets.tools import ToolResultMessage

# from jarvis.interface.textual_ui.widgets.voice_app import VoiceApp  # Not supported in core Settings
from jarvis.interface.textual_ui.windowing import (
...
class VibeApp(App):  # noqa: PLR0904
    ...
    def _get_slash_argument_entries(
        ...
        if cmd_name == "themes":
            from jarvis.interface.cli.config import load_config
    ...
    def _get_bash_max_output_bytes(self) -> int:
        from jarvis.interface.textual_ui.cli_adapters import BashToolConfig
...
"""
    ...
    async def action_toggle_thinking(self) -> None:
        ...
        from jarvis.interface.textual_ui.widgets.messages import ReasoningMessage
    ...
    def _copy_last_answer(self, **kwargs: Any) -> None:
        ...
        try:
            from jarvis.core.clipboard import copy_to_clipboard
