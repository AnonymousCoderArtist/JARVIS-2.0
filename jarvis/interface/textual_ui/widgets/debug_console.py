...
from jarvis.interface.textual_ui.cli_adapters import LogEntry as LogEntryData
from jarvis.interface.textual_ui.cli_adapters import LogReader, decode_log_message
