...
from jarvis.interface.textual_ui.widgets.chat_input.body import ChatInputBody
from jarvis.interface.textual_ui.widgets.chat_input.completion_manager import (
    MultiCompletionManager,
)
from jarvis.interface.textual_ui.widgets.chat_input.completion_popup import (
...
class ChatInputContainer(Vertical):
    ...
    def _get_slash_entries(self) -> list[tuple[str, str]]:
        ...
        for command in self._command_registry.commands.values():
            ...
            if command.usage:
                description = f"{description} · {command.usage}"
