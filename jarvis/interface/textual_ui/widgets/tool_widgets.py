...
from jarvis.interface.textual_ui.ansi_markdown import AnsiMarkdown as Markdown
            ...
            try:
                if path.exists():
                    ...
                    if diff_text:
                        ...
                        from jarvis.interface.textual_ui.widgets.tools import DiffBlock
...
def parse_diff_text(diff_text: str) -> list:
    ...
    from jarvis.interface.textual_ui.widgets.tools import DiffLine
...
def get_approval_widget(tool_name: str, args: BaseModel | dict) -> ToolApprovalWidget:
    ...
    if isinstance(args, dict):
        if not args:
            # Empty dict - skip model instantiation
...
def get_result_widget(
    ...
    if tool_name == "ls" and isinstance(result, list):
        ...
        from jarvis.interface.textual_ui.tool_results import GrepMatch
        matches = []
        for r in result:
