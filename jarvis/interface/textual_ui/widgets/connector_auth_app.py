...
from jarvis.interface.textual_ui.cli_adapters import ConnectorRegistry, copy_text_to_clipboard
from jarvis.interface.textual_ui.widgets.no_markup_static import NoMarkupStatic

if TYPE_CHECKING:
    from jarvis.interface.textual_ui.agent_loop import ToolManagerAdapter
    from jarvis.interface.textual_ui.cli_adapters import ToolManager
