...
from jarvis.core.agents.async_manager import AsyncAgentConfig, AsyncAgentManager
...
from jarvis.core.events import EventBus, HookRegistry
from jarvis.core.history import ConversationHistory
from jarvis.core.learn import LearningConfig, LearningManager
from jarvis.core.llm.sdk_adapter import SDKAdapter
from jarvis.core.llm_sdk.anthropic.sdk import AnthropicSDK
from jarvis.core.llm_sdk.openai.sdk import OpenAISDK
from jarvis.core.skills.manager import SkillManager
from jarvis.core.tools.agent_tool import AgentsTool
from jarvis.core.tools.async_registry import AsyncToolRegistry
from jarvis.core.tools.background_tools import ListBackgroundProcessesTool, ReadBackgroundOutputTool
from jarvis.core.tools.code_tools import BashTool, RunTestsTool
from jarvis.core.tools.file_edit_tool import EditTool
from jarvis.core.tools.file_tools import FileReadTool, FileWriteTool, FindTool, LSTool
from jarvis.core.tools.grep_tool import GrepSearchTool
from jarvis.core.tools.memory_tool import ReadMemoryTool, SaveMemoryTool
from jarvis.core.tools.repl_tool import REPLTool
from jarvis.core.tools.tool_search_tool import ToolSearchTool
from jarvis.core.tools.web_tools import ExaWebSearchTool, WebFetchTool
from jarvis.core.tools.worktree_tool import EnterWorktreeTool, ExitWorktreeTool
...
class CLIInterface:
    ...
    async def _initialize_mcp_servers_async(self):
        ...
        try:
            from jarvis.core.tools.mcp_adapter import MCPRegistry
    ...
    def _initialize_tools(self):
        ...
        from jarvis.core.tools import AskUserQuestionTool
        self.tool_registry.register(AskUserQuestionTool())
        self.tool_registry.register(AgentsTool())
        from jarvis.core.tools import SkillTool
        ...
        from jarvis.core.tools.watcher_tool import WatcherStatusTool
        self.tool_registry.register(WatcherStatusTool())

    async def _load_extensions(self):
        """Discover and load extensions via the ExtensionRunner system."""
        from jarvis.core.extensions import ExtensionRunner
    ...
    def _create_mcp_config(self, config_dict: dict):
        ...
        from jarvis.core.tools.mcp_adapter import MCPServerConfig, MCPTransportType
    ...
    async def _handle_tool_approval(self, tool_name: str, tool_args: dict[str, Any], tool_call_id: str, required_permissions: list[Any]):
        ...
        """
        from jarvis.interface.cli.display import show_approval_prompt
    ...
    async def _handle_submit(self, text: str):
        ...
        from jarvis.core.history import create_user_message
